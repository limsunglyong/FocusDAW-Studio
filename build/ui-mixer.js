...
function AudioInputControls({ track, inputLevel, inputGr = 0, onParam, onBeforeChange }) {
  ...
  ), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", justifyItems: "center", gap: 1, whiteSpace: "nowrap" }, title: `Input gain ${fmtDb(inputGain)} dB` }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 8, color: "var(--muted)", fontWeight: 700, letterSpacing: ".1em" } }, "GAIN"), /* @__PURE__ */ React.createElement("span", { className: "mono", style: { fontSize: 9.5, color: "var(--cream-2)" } }, fmtDb(inputGain), " dB")))), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, alignItems: "flex-start", flex: "0 0 auto" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "grid", justifyItems: "center", gap: 3 } }, /* @__PURE__ */ React.createElement(InputLevelMeter, { level: liveLevel, height: 80, width: 7 }), /* @__PURE__ */ React.createElement("span", { className: "mono", title: "Live input level", style: {
    fontSize: 8,
    fontWeight: 400,
    letterSpacing: ".06em",
