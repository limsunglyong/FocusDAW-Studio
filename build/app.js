...
function Studio({ projectName, projectNameRef, projectPath, startupReady, registerHandlers, onRenameProject, onProjectPathChange, onUndoStateChange, theme, mixerTexture }) {
  ...
  const selectFileTrack = useCallback((trackId, e) => {
    ...
    setSelectedFileTrackIds((current) => {
      const anchorId = lastSelectedFileTrackId.current && fileTrackIdSet.has(lastSelectedFileTrackId.current) ? lastSelectedFileTrackId.current : current.find((id) => fileTrackIdSet.has(id));
      if (shift && anchorId) {
        ...
        if (from >= 0 && to >= 0) {
          ...
          return ctrl ? Array.from(/* @__PURE__ */ new Set([...current, ...range])) : range;
        }
      }
      if (ctrl) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", position: "relative" } }, recordCount != null && /* @__PURE__ */ React.createElement("div", { style: {
    ...
    lineHeight: 1,
    color: "var(--cream)",
    fontFamily: '"Orbitron", var(--mono, monospace)',
    ...
    empty ? /* @__PURE__ */ React.createElement(EmptyState, { dragOver, onPick: pickAudioFiles, onPickFolder: pickAudioFolder, onDemo: loadDemo }) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { position: "relative", minWidth: "min-content" } }, /* @__PURE__ */ React.createElement(Ruler, { pxPerSec, playhead, onSeek: guardedUserSeek, onAddTrack: pickAudioFiles, onAddAudioIn: addAudioInTrack }), fileTracks.length > 0 && /* @__PURE__ */ React.createElement(
      FileTrackGroupHeader,
      {
        ...
        pxPerSec,
        playhead,
        stats: fileTrackStats,
        selectedCount: selectedFileTracks.length,
  ...
  ), !empty && vScroll.up && /* @__PURE__ */ React.createElement("button", { className: "arrange-scroll-arrow up", onClick: () => scrollArrangeV(-1), title: "Scroll up", "aria-label": "Scroll tracks up" }, /* @__PURE__ */ React.createElement("span", { className: "arrange-scroll-disc" }, /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 24 24", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("polyline", { points: "4 15 12 7 20 15", fill: "none", stroke: "currentColor", strokeWidth: "2.4", strokeLinecap: "round", strokeLinejoin: "round" })))), !empty && vScroll.down && /* @__PURE__ */ React.createElement("button", { className: "arrange-scroll-arrow down", onClick: () => scrollArrangeV(1), title: "Scroll down", "aria-label": "Scroll tracks down" }, /* @__PURE__ */ React.createElement("span", { className: "arrange-scroll-disc" }, /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 24 24", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("polyline", { points: "4 9 12 17 20 9", fill: "none", stroke: "currentColor", strokeWidth: "2.4", strokeLinecap: "round", strokeLinejoin: "round" })))), showExport && /* @__PURE__ */ React.createElement(ExportDialog, { projectName, onClose: () => setShowExport(false) }), mergeTracksNotice && /* @__PURE__ */ React.createElement(
    "div",
    {
      style: { position: "fixed", inset: 0, zIndex: 1100, background: "rgba(8,6,4,.6)", backdropFilter: "blur(3px)", display: "grid", placeItems: "center" },
      onMouseDown: () => {
        if (!mergeTracksBusy) setMergeTracksNotice(false);
      }
    },
    /* @__PURE__ */ React.createElement("div", { onMouseDown: (e) => e.stopPropagation(), style: { width: 460, background: "var(--bg)", border: "1px solid var(--line-strong)", borderRadius: 14, boxShadow: "var(--shadow)", overflow: "hidden" } }, /* @__PURE__ */ React.createElement("div", { style: { padding: "16px 20px", borderBottom: "1px solid var(--line)", display: "flex", alignItems: "center", gap: 10 } }, /* @__PURE__ */ React.createElement(Icon, { name: "mixer", size: 17, style: { color: "var(--amber)" } }), /* @__PURE__ */ React.createElement("span", { style: { fontWeight: 600, fontSize: 14 } }, "Merge Tracks")), /* @__PURE__ */ React.createElement("div", { style: { padding: "18px 20px", display: "grid", gap: 14 } }, /* @__PURE__ */ React.createElement("div", { style: { padding: "10px 12px", borderRadius: 8, background: "var(--surface2)", border: "1px solid var(--line)", color: "var(--cream-2)", fontSize: 12.5, lineHeight: 1.5 } }, selectedFileTracks.map((track) => track.name).join(", ")), /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "110px 1fr", gap: "12px 14px", alignItems: "center", fontSize: 12.5 } }, /* @__PURE__ */ React.createElement("span", { style: { color: "var(--muted)", fontWeight: 600 } }, "Track Name"), /* @__PURE__ */ React.createElement(
      "input",
      {
        value: mergeTracksName,
    ...
    ), /* @__PURE__ */ React.createElement("span", { style: { color: "var(--muted)", fontWeight: 600 } }, "Channels"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8 } }, /* @__PURE__ */ React.createElement(
      "button",
      {
        className: mergeTracksOptions.channels === "stereo" ? "btn primary" : "btn",
        disabled: mergeTracksBusy,
      ...
      "button",
      {
        className: mergeTracksOptions.channels === "mono" ? "btn primary" : "btn",
        disabled: mergeTracksBusy,
        onClick: () => updateMergeTracksOption("channels", "mono"),
        style: { padding: "7px 12px" }
      },
      "Mono"
    )), /* @__PURE__ */ React.createElement("span", { style: { color: "var(--muted)", fontWeight: 600 } }, "Originals"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, flexWrap: "wrap" } }, /* @__PURE__ */ React.createElement(
      "button",
      {
        className: mergeTracksOptions.originals === "mute" ? "btn primary" : "btn",
        disabled: mergeTracksBusy,
      ...
      "button",
      {
        className: mergeTracksOptions.originals === "keep" ? "btn primary" : "btn",
        disabled: mergeTracksBusy,
      ...
      "button",
      {
        className: mergeTracksOptions.originals === "delete" ? "btn primary" : "btn",
        disabled: mergeTracksBusy,
        onClick: () => updateMergeTracksOption("originals", "delete"),
        style: { padding: "7px 12px" }
      },
      "Delete"
    ))), /* @__PURE__ */ React.createElement("div", { style: { borderTop: "1px solid var(--line)", paddingTop: 14, display: "flex", justifyContent: "flex-end", gap: 10, marginTop: 2 } }, /* @__PURE__ */ React.createElement("button", { className: "btn", disabled: mergeTracksBusy, onClick: () => setMergeTracksNotice(false) }, "Cancel"), /* @__PURE__ */ React.createElement("button", { className: "btn primary", disabled: mergeTracksBusy || selectedFileTracks.length < 2, onClick: renderMergedTracks }, mergeTracksBusy ? "Rendering..." : "Create Bounce"))))
  ), confirmDeleteAll && /* @__PURE__ */ React.createElement(
    "div",
    {
      style: { position: "fixed", inset: 0, zIndex: 1100, background: "rgba(8,6,4,.6)", backdropFilter: "blur(3px)", display: "grid", placeItems: "center" },
